#include "CEqualNumberCommand.h"
#include "CMessage.h"
#include "CCommandExecuteThread.h"
#include "CValue.h"


CEqualNumberCommand::CEqualNumberCommand() {}
...
QList<CCommand::ParamType> CEqualNumberCommand::getParamTypes() const
{
...
void CEqualNumberCommand::executeNextStep(CCommandExecuteThread &executionThread) const
{
...
bool CEqualNumberCommand::addParameter(CCommand *parameter, int index)
{
