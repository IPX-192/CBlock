#include "CPlusCommand.h"
#include "CMessage.h"
#include "CCommandExecuteThread.h"
#include "CValue.h"


CPlusCommand::CPlusCommand() {}
...
QList<CCommand::ParamType> CPlusCommand::getParamTypes() const
{
...
void CPlusCommand::executeNextStep(CCommandExecuteThread &executionThread) const
{
...
bool CPlusCommand::addParameter(CCommand *parameter, int index)
{
