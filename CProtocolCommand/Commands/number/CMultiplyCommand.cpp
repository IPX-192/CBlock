#include "CMultiplyCommand.h"
#include "CMessage.h"
#include "CCommandExecuteThread.h"
#include "CValue.h"


CMultiplyCommand::CMultiplyCommand() {}
...
QList<CCommand::ParamType> CMultiplyCommand::getParamTypes() const
{
...
void CMultiplyCommand::executeNextStep(CCommandExecuteThread &executionThread) const
{
...
bool CMultiplyCommand::addParameter(CCommand *parameter, int index)
{
