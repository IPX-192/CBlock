#include "CMinusCommand.h"
#include "CMessage.h"
#include "CCommandExecuteThread.h"
#include "CValue.h"

CMinusCommand::CMinusCommand() {}
...
QList<CCommand::ParamType> CMinusCommand::getParamTypes() const
{
...
void CMinusCommand::executeNextStep(CCommandExecuteThread &executionThread) const
{
...
bool CMinusCommand::addParameter(CCommand *parameter, int index)
{
