#include "CDivideCommand.h"
#include "CMessage.h"
#include "CCommandExecuteThread.h"
#include "CValue.h"

CDivideCommand::CDivideCommand()
{
...
QList<CCommand::ParamType> CDivideCommand::getParamTypes() const
{
...
void CDivideCommand::executeNextStep(CCommandExecuteThread &executionThread) const
{
...
bool CDivideCommand::addParameter(CCommand *parameter, int index)
{
